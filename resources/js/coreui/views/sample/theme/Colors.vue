  ...
  <div class="animated fadeIn">
    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="row">
          <div class="col-md-4">
            <div class="p-3 mb-3 bg-blue">
              Blue
            </div>
          </div>
          <div class="col-md-4">
            <div class="p-3 mb-3 bg-indigo">
              Indigo
            </div>
          </div>
          <div class="col-md-4">
            <div class="p-3 mb-3 bg-purple">
              Purple
            </div>
          </div>
          <div class="col-md-4">
            <div class="p-3 mb-3 bg-pink">
              Pink
            </div>
          </div>
          <div class="col-md-4">
            <div class="p-3 mb-3 bg-red">
              Red
            </div>
          </div>
          <div class="col-md-4">
            <div class="p-3 mb-3 bg-orange">
              Orange
            </div>
          </div>
          <div class="col-md-4">
            <div class="p-3 mb-3 bg-yellow">
              Yellow
            </div>
          </div>
          <div class="col-md-4">
            <div class="p-3 mb-3 bg-green">
              Green
            </div>
          </div>
          <div class="col-md-4">
            <div class="p-3 mb-3 bg-teal">
              Teal
            </div>
          </div>
          <div class="col-md-4">
            <div class="p-3 mb-3 bg-cyan">
              Cyan
            </div>
          </div>
        </div>
