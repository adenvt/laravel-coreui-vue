    ...
    <b-card>
      <b-row>
        <b-col sm="5">
          <h4
            id="traffic"
            class="card-title mb-0">Traffic</h4>
        ...
        <b-col
          ...
          <b-button
            type="button"
            variant="primary"
            class="float-right"><i class="icon-cloud-download"/></b-button>
          <b-button-toolbar
            class="float-right"
            ...
            <b-form-radio-group
              ...
              <b-form-radio
                class="mx-0"
                value="Day">Day</b-form-radio>
              <b-form-radio
                class="mx-0"
                value="Month">Month</b-form-radio>
              <b-form-radio
                class="mx-0"
                value="Year">Year</b-form-radio>
            </b-form-radio-group>
          </b-button-toolbar>
        </b-col>
      </b-row>
            ...
            <b-col
              ...
              <ul class="horizontal-bars">
                ...
                <li class="legend">
                  <b-badge
                    pill
                    variant="info"/> <small>New clients</small> &nbsp; <b-badge
                      pill
                      variant="danger"/> <small>Recurring clients</small>
                </li>
              </ul>
            </b-col>
            <b-col
              ...
              <ul class="icons-list">
                <li>
                  ...
                  <div class="actions">
                    <b-button
                      variant="link"
                      class="text-muted"><i class="icon-settings"/></b-button>
                  </div>
                </li>
                <li>
